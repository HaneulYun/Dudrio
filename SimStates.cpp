...
{
	// 건물 건설
	BuildingBuilder::buildingBuilder->simBuild(sim->buildInfo.pos, 0, sim->buildInfo.buildingType, sim->buildInfo.buildingIndex, sim->home->GetComponent<Building>()->landmark);
