...
void BuildingBuilder::serializeBuildings()
{
	...
	//building[Theme].push_back(makeBuilderDataAsMeshAndMaterial(L"SE_Gazebo_01_SM", ASSET MESH("SE_Gazebo_01_SM_LOD0"), ASSET MATERIAL("SE_Gazebo")));
	//building[Theme].push_back(makeBuilderDataAsMeshAndMaterial(L"SE_GreenHouse_01_SM", ASSET MESH("SE_GreenHouse_01_SM_LOD0"), ASSET MATERIAL("SE_Greenhouse")));
