...
float HostInformConnector::terrainSize = 1000;
int HostInformConnector::frequency;	// 0 ~ 64
int HostInformConnector::octaves;	// 0 ~ 16
int HostInformConnector::seed;	// ~4byte
